...
import (
	...
	aiplatformv1alpha1 "aiplatform/k8gentai-operator.git/api/v1alpha1"
	"aiplatform/k8gentai-operator.git/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "59cd5c7b.aiplatform.io",
	...
	if err = (&controller.K8gentaiReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "K8gentai")
		os.Exit(1)
	}
	if err = (&controller.ComponentDefinitionReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
